...
export default function RegulationDetailPage() {
  ...
  return <View className="regulation-detail">
    ...
    <View className="regulation-detail__section"><Text className="regulation-detail__heading">摘要</Text><Text className="regulation-detail__copy" userSelect>{item.summary}</Text></View>
    <View className="regulation-detail__section"><Text className="regulation-detail__heading">索引正文</Text><Text className="regulation-detail__copy regulation-detail__content" userSelect>{item.content}</Text></View>

...
export function FeatureFlagsPage() {
  ...
  return <Space direction="vertical" size="large" style={{ width: '100%' }}>
    ...
    <Card title={<Space>V2.0 模块开关<Tag color={forumEnabled ? 'orange' : 'default'}>{forumEnabled ? '论坛已启用' : '论坛已关闭'}</Tag></Space>} loading={loading}>
      <Form form={form} layout="vertical" initialValues={{ route_enabled: false, regulation_enabled: false, forum_enabled: false, forum_write_enabled: false, forum_publish_mode: 'invite_only' }}>
